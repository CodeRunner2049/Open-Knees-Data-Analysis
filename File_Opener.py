    ...
    def print_files_with_deviation (self):
        ...
        for index, root_file in self.file_dict.items():
            ...
            [print(x_columnName + " std_deviation: " +
                    str(self.algorithm.do_std_devation(x_chunk[x_columnName]))) for x_columnName in x_chunk.columns.values]
            [print(y_columnName + " std_deviation: " +
                    str(self.algorithm.do_std_devation(y_chunk[y_columnName]))) for y_columnName in y_chunk.columns.values]
            print('\n')
